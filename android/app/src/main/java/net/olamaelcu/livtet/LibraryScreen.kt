 ...
 * The FloatingActionButton opens the 5-step AddBook wizard.
 *
 * Filters, search, pull-to-refresh, and cover thumbnails are deferred
...
fun LibraryScreen(
    ...
    if (showWizard) {
        AddBookWizard(onDismiss = { showWizard = false })
    }
}
